...
<head>
    ...
    <title>Makeup Services — Shringar</title>
...
<div class="user-wrap-wide">
    <div class="svc-hero">
        <div class="svc-hero-bg" style="background-image:url('${pageContext.request.contextPath}/images/makeup.png');"></div>
        <div class="svc-hero-title">Makeup Services</div>
    </div>

    <c:if test="${empty services}">
        <div class="empty-card">
            <p class="user-page-intro" style="margin-bottom:10px;">No makeup services found.</p>
