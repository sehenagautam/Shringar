...
<body class="auth-login-page">
    <div class="auth-login-card">
        ...
        <form class="auth-login-form" action="${pageContext.request.contextPath}/user/login" method="post">
        ...
        <p class="auth-login-footer">
            <a href="${pageContext.request.contextPath}/user/register">Create an account</a>
            · <a href="${pageContext.request.contextPath}/index.jsp">Home</a>
            · <a href="${pageContext.request.contextPath}/test-login">Demo login</a>
        </p>
    </div>
</body>
</html>
