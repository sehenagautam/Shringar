        ...
        <div class="auth-reg-card">
            ...
            <form action="${pageContext.request.contextPath}/register" method="post" enctype="multipart/form-data">
                <div class="auth-reg-field">
                    ...
                    <input id="name" type="text" name="fullName" required maxlength="120" value="${empty param.fullName ? param.name : param.fullName}"/>
                </div>
                <div class="auth-reg-field">
            ...
            <p class="auth-reg-bottom">Already have an account? <a href="${pageContext.request.contextPath}/login">Sign in</a></p>
        </div>
    </div>
</body>
</html>
