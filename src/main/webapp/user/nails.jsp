...
<head>
    ...
    <title>Nail Services — Shringar</title>
...
<div class="user-wrap-wide">
    <div class="svc-hero">
        <div class="svc-hero-bg" style="background-image:url('${pageContext.request.contextPath}/images/makeup4.png');"></div>
        <div class="svc-hero-title">Nail Services</div>
    </div>

    <c:if test="${empty services}">
        <div class="empty-card">
            <p class="user-page-intro" style="margin-bottom:10px;">No nail services found.</p>
