...
<main class="main-container">
    <section class="page-title services-title">
        ...
        <div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap;margin-top:20px;">
            <a href="${pageContext.request.contextPath}/search" style="display:inline-block;padding:12px 22px;border-radius:999px;background:#d9c4b8;color:#3a2d28;font-weight:600;">Search Services</a>
            <a href="${pageContext.request.contextPath}/login" style="display:inline-block;padding:12px 22px;border-radius:999px;background:#2c2c2c;color:#ffffff;font-weight:600;">Book Appointment</a>
        </div>
    </section>
